...
def initialize_main_app():
    global current_offset, sort_column, sort_order, selected_profile, is_profile, limit, profiles, host, user, password, database
    ...
    def on_next():
        global current_offset, is_profile, selected_option, selected_profile
    ...
    def on_previous():
        global current_offset, is_profile, selected_profile, selected_profile
    ...
    def on_go_to_page():
        try:
            ...
            global current_offset, is_profile, selected_profile, selected_option
